...
import sty from "./PlasmicContainer.module.css"; // plasmic-import: yjb-qhVvhQe-/css
...
export type PlasmicContainer__VariantsArgs = {
  ...
  >;
  overflowVisible?: SingleBooleanChoiceArg<"overflowVisible">;
};
    ...
    <div
      ...
      className={classNames(
        ...
        sty.container,
        {
          ...
          [sty.containeroverflowVisible]: hasVariant(
            $state,
            "overflowVisible",
            "overflowVisible"
          ),

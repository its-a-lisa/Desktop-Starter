...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: ImVovFGYKmjP/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: FrN9fU2OadSM/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__l8Hw5)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__bhv7)}
              />
            </React.Fragment>
          ),
          value: args.children,

...
export type FaPencilAltSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaPencilAltSvgIcon(props: FaPencilAltSvgIconProps) {
...
export default FaPencilAltSvgIcon;
/* prettier-ignore-end */

...
export type PfIconSaveSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function PfIconSaveSvgIcon(props: PfIconSaveSvgIconProps) {
...
export default PfIconSaveSvgIcon;
/* prettier-ignore-end */

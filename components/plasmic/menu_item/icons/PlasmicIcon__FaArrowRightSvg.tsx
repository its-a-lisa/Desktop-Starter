...
export type FaArrowRightSvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function FaArrowRightSvgIcon(props: FaArrowRightSvgIconProps) {
...
export default FaArrowRightSvgIcon;
/* prettier-ignore-end */

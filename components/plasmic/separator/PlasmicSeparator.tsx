    ...
    >
      <div
        className={classNames(projectcss.all, sty.freeBox__jPhmU, {
          [sty.freeBoxlength_full__jPhmUpn1Yo]: hasVariant(
            $state,
            "length",
            "full"
          ),
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox___5W5Ms, {
            ...
            [sty.freeBoxemphasis_extraEmphasis___5W5MsjxX5K]: hasVariant(
              $state,
              "emphasis",
              "extraEmphasis"
            ),
            [sty.freeBoxemphasis_extraSubtle___5W5Ms28YcF]: hasVariant(
              $state,
              "emphasis",
              "extraSubtle"
            ),
            [sty.freeBoxemphasis_high___5W5MsZlhAg]: hasVariant(
              $state,
              "emphasis",
              "high"
            ),
            [sty.freeBoxemphasis_low___5W5MsuCBhh]: hasVariant(
              $state,
              "emphasis",
              "low"
            ),

...
// Plasmic Project: i4n9AbVD4xq7VvHzvrVDh9
// Component: P54ZNfHeNobv
...
import projectcss from "./plasmic.module.css"; // plasmic-import: i4n9AbVD4xq7VvHzvrVDh9/projectcss
import sty from "./PlasmicSwitch.module.css"; // plasmic-import: P54ZNfHeNobv/css
      ...
      {(hasVariant($state, "noLabel", "noLabel") ? false : true) ? (
        <div
          ...
          className={classNames(projectcss.all, sty.labelContainer, {
            ...
            [sty.labelContainerlabel_reversed]: hasVariant(
              $state,
              "label",
              "reversed"
            ),
            [sty.labelContainerlabel_top]: hasVariant($state, "label", "top"),
